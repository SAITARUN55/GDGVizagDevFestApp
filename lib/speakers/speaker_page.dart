  ...
  Widget socialActions(context, Speaker speaker) => FittedBox(
        child: Row(
          ...
          children: <Widget>[
            ...
            speaker.twitterUrl != null ? IconButton(
              icon: Icon(
            ...
            speaker.linkedinUrl != null ? IconButton(
              icon: Icon(
            ...
            speaker.githubUrl != null ? IconButton(
              icon: Icon(
